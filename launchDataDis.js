...
function updateDisplay(){
    theTime = new Date();
    console.log("The time is " + theTime.getHours() + ":" + (theTime.getMinutes() < 10 ? "0" + theTime.getMinutes() : theTime.getMinutes()) + ":" + theTime.getSeconds());//(theTime.getSeconds() < 10 ? + "0" : theTime.getSeconds()));
    document.getElementById("timeStamp").innerHTML = theTime.getHours() + ":" + (theTime.getMinutes() < 10 ? "0" + theTime.getMinutes() : theTime.getMinutes()) + ":" + theTime.getSeconds();//(theTime.getSeconds() < 10 ? + "0" : theTime.getSeconds());
